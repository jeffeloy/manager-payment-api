        ...
        <DialogContent class="sm:max-w-[500px]">
            ...
            <div v-if="request" class="grid gap-4 py-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <Label class="text-xs text-slate-500">Created at</Label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <Label class="text-xs text-slate-500">Exchange Rate</Label>
                        <div class="font-medium">{{ request.exchange_rate }}</div>
                    </div>
                </div>

                <div v-if="request.rejection_reason" class="rounded-lg bg-red-50 p-3">
                    <Label class="text-xs font-bold text-red-800">Rejection Reason</Label>
